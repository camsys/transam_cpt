...
ActiveRecord::Schema.define(version: 20180330151633) do
  ...
  create_table "activity_line_items", force: :cascade do |t|
    t.string   "object_key",           limit: 12,    null: false
    t.integer  "capital_project_id",   limit: 4,     null: false
    t.integer  "fy_year",              limit: 4,     null: false
    t.integer  "team_ali_code_id",     limit: 4,     null: false
    t.string   "name",                 limit: 255,   null: false
    t.integer  "anticipated_cost",     limit: 4,     null: false
    t.integer  "estimated_cost",       limit: 4
    t.text     "cost_justification",   limit: 65535
    t.boolean  "active"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "activity_line_items_assets", force: :cascade do |t|
    t.integer "activity_line_item_id", limit: 4, null: false
  ...
  create_table "capital_plan_action_types", force: :cascade do |t|
    t.integer "capital_plan_type_id",        limit: 4
    t.integer "capital_plan_module_type_id", limit: 4
  ...
  add_index "capital_plan_action_types", ["capital_plan_module_type_id"], name: "index_capital_plan_action_types_on_capital_plan_module_type_id", using: :btree
  add_index "capital_plan_action_types", ["capital_plan_type_id"], name: "index_capital_plan_action_types_on_capital_plan_type_id", using: :btree

  create_table "capital_plan_actions", force: :cascade do |t|
    t.string   "object_key",                  limit: 12
    t.integer  "capital_plan_id",             limit: 4
    t.integer  "capital_plan_module_id",      limit: 4
    t.integer  "capital_plan_action_type_id", limit: 4
    t.integer  "sequence",                    limit: 4
    t.text     "notes",                       limit: 65535
    t.integer  "completed_pcnt",              limit: 4
  ...
  add_index "capital_plan_actions", ["capital_plan_action_type_id"], name: "index_capital_plan_actions_on_capital_plan_action_type_id", using: :btree
  add_index "capital_plan_actions", ["capital_plan_id"], name: "index_capital_plan_actions_on_capital_plan_id", using: :btree
  add_index "capital_plan_actions", ["capital_plan_module_id"], name: "index_capital_plan_actions_on_capital_plan_module_id", using: :btree

  create_table "capital_plan_module_types", force: :cascade do |t|
    t.integer "capital_plan_type_id",   limit: 4
    t.string  "name",                   limit: 255
    t.string  "class_name",             limit: 255
  ...
  add_index "capital_plan_module_types", ["capital_plan_type_id"], name: "index_capital_plan_module_types_on_capital_plan_type_id", using: :btree

  create_table "capital_plan_modules", force: :cascade do |t|
    t.string   "object_key",                  limit: 12
    t.integer  "capital_plan_id",             limit: 4
    t.integer  "capital_plan_module_type_id", limit: 4
    t.integer  "sequence",                    limit: 4
  ...
  add_index "capital_plan_modules", ["capital_plan_id"], name: "index_capital_plan_modules_on_capital_plan_id", using: :btree
  add_index "capital_plan_modules", ["capital_plan_module_type_id"], name: "index_capital_plan_modules_on_capital_plan_module_type_id", using: :btree

  create_table "capital_plan_types", force: :cascade do |t|
    t.string  "name",        limit: 255
    t.string  "description", limit: 255
    t.boolean "active"
  end

  create_table "capital_plans", force: :cascade do |t|
    t.string   "object_key",           limit: 12
    t.integer  "capital_plan_type_id", limit: 4
    t.integer  "organization_id",      limit: 4
    t.integer  "fy_year",              limit: 4
  ...
  add_index "capital_plans", ["capital_plan_type_id"], name: "index_capital_plans_on_capital_plan_type_id", using: :btree
  add_index "capital_plans", ["organization_id"], name: "index_capital_plans_on_organization_id", using: :btree

  create_table "capital_project_types", force: :cascade do |t|
    t.string  "name",        limit: 64,  null: false
  ...
  create_table "capital_projects", force: :cascade do |t|
    ...
    t.integer  "organization_id",         limit: 4,   null: false
    t.integer  "team_ali_code_id",        limit: 4,   null: false
    t.integer  "capital_project_type_id", limit: 4,   null: false
    t.boolean  "sogr"
    t.boolean  "notional"
  ...
  create_table "capital_projects_districts", force: :cascade do |t|
    t.integer "capital_project_id", limit: 4
    t.integer "district_id",        limit: 4
  end
  ...
  create_table "funding_line_item_types", force: :cascade do |t|
    t.string  "code",        limit: 2
    t.string  "name",        limit: 64
    t.string  "description", limit: 255
    t.boolean "active"
  ...
  create_table "funding_line_items", force: :cascade do |t|
    t.string   "object_key",                limit: 12
    t.integer  "organization_id",           limit: 4
    t.integer  "fy_year",                   limit: 4
    t.integer  "funding_source_id",         limit: 4
    t.integer  "funding_line_item_type_id", limit: 4
    t.string   "project_number",            limit: 64
    t.boolean  "awarded"
    t.integer  "amount",                    limit: 4
    t.integer  "spent",                     limit: 4
    t.integer  "pcnt_operating_assistance", limit: 4
    t.integer  "created_by_id",             limit: 4
    t.integer  "updated_by_id",             limit: 4
    t.boolean  "active"
    t.datetime "created_at"
  ...
  create_table "funding_requests", force: :cascade do |t|
    t.string   "object_key",                   limit: 12
    t.integer  "activity_line_item_id",        limit: 4
    t.integer  "federal_funding_line_item_id", limit: 4
    t.integer  "state_funding_line_item_id",   limit: 4
    t.integer  "federal_amount",               limit: 4
    t.integer  "state_amount",                 limit: 4
    t.integer  "local_amount",                 limit: 4
    t.integer  "created_by_id",                limit: 4
    t.integer  "updated_by_id",                limit: 4
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "milestones", force: :cascade do |t|
    t.string   "object_key",            limit: 12,  null: false
    t.integer  "activity_line_item_id", limit: 4,   null: false
    t.integer  "milestone_type_id",     limit: 4,   null: false
  ...
  create_table "user_activity_line_item_filters", force: :cascade do |t|
    t.string   "object_key",              limit: 12,  null: false
    t.string   "name",                    limit: 64,  null: false
    t.string   "description",             limit: 256, null: false
    t.integer  "capital_project_type_id", limit: 4
    t.string   "sogr_type",               limit: 255
    t.string   "team_ali_codes",          limit: 255
    t.string   "districts",               limit: 255
    t.string   "planning_year",           limit: 255
    t.string   "asset_types",             limit: 255
    t.string   "asset_subtypes",          limit: 255
    t.string   "asset_query_string",      limit: 255
    t.boolean  "in_backlog"
    t.integer  "resource_id",             limit: 4
    t.string   "resource_type",           limit: 255
  ...
  create_table "user_activity_line_item_filters_organizations", force: :cascade do |t|
    t.integer "user_activity_line_item_filter_id", limit: 4, null: false
    t.integer "organization_id",                   limit: 4, null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at",                                    null: false
    t.datetime "updated_at",                                    null: false
    t.integer  "user_activity_line_item_filter_id", limit: 4
  end
  ...
  create_table "users_user_activity_line_item_filters", force: :cascade do |t|
    t.integer "user_id",                           limit: 4, null: false
    t.integer "user_activity_line_item_filter_id", limit: 4, null: false
  end

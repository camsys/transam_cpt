  ...
  class AuthorizedCptAbility
    ...
    def initialize(user, organization_ids=[])
      ...
      can [:update, :destroy], ActivityLineItem do |ali|
        ali.capital_project.sogr? == false and ali.capital_project.can_update? and organization_ids.include?(ali.capital_project.organization_id) and !ali.is_agency_planning_complete? and !ali.pinned?
      end

      can [:update_cost], ActivityLineItem do |ali|
        ali.capital_project.can_update? and organization_ids.include?(ali.capital_project.organization_id) and !ali.is_agency_planning_complete? and !ali.pinned?
      end

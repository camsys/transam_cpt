...
class CapitalProjectBuilder
  ...
  def create_draft_project(scope, notional, organization, project_type)
    ...
    draft_project.title = "#{scope_context[1]}: #{scope_context[2]}: #{scope.name} project"
    draft_project.sogr = true
    # Temporary to work around validation; will be overwritten layer
    draft_project.project_number = "If you see this message, please report a bug"
    ...
    #Cannot create many to many field until the Project is saved

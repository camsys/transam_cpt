class AssetPreparationCapitalPlanAction < BaseCapitalPlanAction
  ...
  def complete
    ...
    Audit.all.each do |audit|
      audit_results = report.get_data(audit, [@capital_plan_action.capital_plan.organization_id], Rails.application.config.asset_base_class_name, {disposition_date: nil},{})
      total_assets = 0
      passed_assets = 0
